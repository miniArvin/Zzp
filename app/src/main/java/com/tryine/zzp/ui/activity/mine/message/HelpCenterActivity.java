...
public class HelpCenterActivity extends BaseStatusMActivity implements View.OnClickListener {
    ...
    public void loadData() {
        ...
        findViewById(R.id.new_user_tv).setOnClickListener(this);
...
//                HelpCenter helpCenter = (HelpCenter) mineMessagesAdapter.getItem(position);
//                content_id=helpCenter.getList().get(position).getContent_id();
