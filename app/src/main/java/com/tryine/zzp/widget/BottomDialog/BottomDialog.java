package com.tryine.zzp.widget.BottomDialog;
...
public class BottomDialog extends BaseBottomDialog {
    ...
    private static final String KEY_GRATITY = "params_gravity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mGravity = savedInstanceState.getInt(KEY_GRATITY);
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt(KEY_GRATITY,mGravity);
