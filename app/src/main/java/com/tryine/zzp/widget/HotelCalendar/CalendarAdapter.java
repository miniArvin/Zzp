package com.tryine.zzp.widget.HotelCalendar;
...
import com.tryine.zzp.widget.HotelCalendar.view.CustomCalendarTextView;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        if (holder instanceof DayViewHolder) {
            ...
            if (item.getState() == HotelDayBean.STATE_PAST) {
                ...
                ((DayViewHolder) holder).day.setTextColor(resources.getColor(R.color.black));
            } else if (item.getState() == HotelDayBean.STATE_WEEKEND) {
                ((DayViewHolder) holder).day.setTextColor(resources.getColor(R.color.orange));
            }
            ...
            if (item.getState() == HotelDayBean.STATE_STARTED) {
                ...
                ((DayViewHolder) holder).day.setTextColor(resources.getColor(R.color.white));
                if (!((DayViewHolder) holder).day.getText().equals(""))
