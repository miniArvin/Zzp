...
public class BottomTabView extends LinearLayout {
    ...
    public TabItemView getTabItemView(int position) {
        if (this.tabItemViews != null) {
            return tabItemViews.get(position);
        }
        return null;
    }
    ...
    public static class TabItemView extends LinearLayout {
        ...
        public void init() {
            ...
            viewPoint = view.findViewById(R.id.tab_point_view);
            textNum = (TextView) view.findViewById(R.id.tab_point_text_num);
