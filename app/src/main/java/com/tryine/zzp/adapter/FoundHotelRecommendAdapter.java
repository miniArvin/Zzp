...
public class FoundHotelRecommendAdapter extends RecyclerView.Adapter<FoundHotelRecommendAdapter.ViewHolder> {
    private final View mParent;
    private LayoutInflater mLayoutInflater;
    private Context mContext;
    private List<FoundEntity.InfoBean.HotelBean> mData;
    private OnUseClickListener onUseClickListener;

    public FoundHotelRecommendAdapter(Context context, List<FoundEntity.InfoBean.HotelBean> hotelBeen, View parent) {
